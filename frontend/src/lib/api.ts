...
export const posApi = {
  ...
  setItemDiscount:  (orderId: string, itemId: string, discount: number) => api.post(`/pos/orders/${orderId}/items/${itemId}/discount`, { discount }),
...
export const inventoryApi = {
  ...
  updatePrice:    (id: string, d: { sale_price?: number; cost_price?: number }) => api.put(`/inventory/items/${id}/price`, d),
