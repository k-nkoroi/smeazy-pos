...
pub fn pos_routes(svc: Arc<PosService>, auth: AuthState) -> Router {
    Router::new()
        ...
        .route("/pos/orders/:id/items/:item_id/discount", post(set_item_discount))
